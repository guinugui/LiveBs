...
class WorkoutPlanService {
  ...
  static Future<List<WorkoutPlan>> fetchWorkoutPlans(String userEmail, String password) async {
    try {
  ...
  static Future<void> deleteWorkoutPlan(String email, String password, String planId) async {
    try {
      // Login first
      final loginResponse = await http.post(
        Uri.parse('$baseUrl/auth/login'),
