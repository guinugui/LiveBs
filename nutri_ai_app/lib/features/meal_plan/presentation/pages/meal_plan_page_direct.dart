...
class _MealPlanPageState extends State<MealPlanPage> {
  ...
  // Credenciais do usuário atual (serão obtidas do contexto de autenticação)
  String? _userEmail;
  ...
  void initState() {
    super.initState();
    print('[MEAL_PLAN_PAGE] 🚀 PÁGINA INICIALIZADA - OBTENDO USUÁRIO ATUAL');
    _initializeUser();
  }
  ...
  Future<void> _initializeUser() async {
    try {
      // TODO: Implementar obtenção real do usuário logado
      // Por ora, usando credenciais temporárias para manter funcionamento
      _userEmail = 'gui@gmail.com';
      _userPassword = '123123';
      
      await _forcedLoadPlans();
    } catch (e) {
      print('[❌ USER ERROR] Erro ao obter usuário: $e');
      if (mounted) {
  ...
  Future<void> _forcedLoadPlans() async {
    if (_userEmail == null || _userPassword == null) {
      print('[⚠️ WARNING] Usuário não está logado');
      return;
    }
