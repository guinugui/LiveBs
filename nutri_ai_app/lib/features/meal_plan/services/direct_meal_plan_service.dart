...
class DirectMealPlanService {
  ...
  static Future<List<Map<String, dynamic>>> fetchPlansDirectly(
    String userEmail,
    String password,
  ) async {
    try {
  ...
  static Future<Map<String, dynamic>> createPlanDirectly(
    String userEmail,
    String password,
  ) async {
    try {
  ...
  static Future<void> deletePlanDirectly(
    String userEmail,
    String password,
    String planId,
  ) async {
  ...
  static Future<Map<String, dynamic>> fetchPlanDetailsDirectly(
    String userEmail,
    String password,
    String planId,
  ) async {
